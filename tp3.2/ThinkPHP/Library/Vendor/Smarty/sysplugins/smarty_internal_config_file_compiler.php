...
class Smarty_Internal_Config_File_Compiler {
     ...
     *
     * If parameter $args contains a string this is used as error index
     *
     * @param string $args individual error index or null
     */
