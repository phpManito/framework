	...
	public function send_multi_request($handles, $opt = null) {
		...
		do {
			...
			while ( $done = curl_multi_info_read ( $multi_handle ) ) {
				...
				} // Because curl_multi_info_read() might return more than one index about a request, we check to see if this request is already in our array of completed requests
